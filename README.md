...
| `ssid`                  | Android, iOS          | `string`  | The SSID of the network. May not be present, `null`, or an empty string if it cannot be determined. **On iOS, make sure to enable [NEHotspotConfigurationManager](#ios-nehotspotconfigurationmanager)**.                        |
...
**@react-native-community/netinfo** uses NEHotspotConfigurationManager to get information about the WiFi SSID. To use the NEHotspotConfigurationManager class, you must enable the Hotspot Configuration capability in [Xcode](http://help.apple.com/xcode/mac/current/#/dev88ff319e7).

1. [Link target](https://help.apple.com/xcode/mac/current/#/dev51a648b07) to the *@react-native-community/netinfo* library
2. [Link target](https://help.apple.com/xcode/mac/current/#/dev51a648b07) to `NetworkExtension.framework` framework
3. [Enable](http://help.apple.com/xcode/mac/current/#/dev88ff319e7) `Hotspot Configuration`
4. For iOS 12 [Enable](http://help.apple.com/xcode/mac/current/#/dev88ff319e7) `Access WiFi Information`
