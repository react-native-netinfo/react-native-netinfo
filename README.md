...
| `rssi`                  | Android                           | `number`  | The raw signal strength (rssi) value for the network. https://en.wikipedia.org/wiki/Received_signal_strength_indication. May not be present if it cannot be determined. |
